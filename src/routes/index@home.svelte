<script lang="ts">
	...
	import { getWindowHeight, getDocHeight, progress, scrollEnabled, throttle } from 'utils';
	...
	const throttledScroll = throttle(function scroll(e: WheelEvent, direction: number) {
...
<svelte:head>
	<title>It's Keyy - Portfolio</title>
	<meta name="description" content="Rifky Abdul Hanan's Portfolio Site" />
</svelte:head>
