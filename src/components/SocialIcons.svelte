...
<section class="container social">
	<div class="social-icons">
		<a title="email" href="mailto:rifkyabdulhanan@gmail.com">
			<svg
				class="icon"
		...
		<a title="instagram" href="https://www.instagram.com/meowjestic_/" target="_blank" rel="noopener">
			<svg
				class="icon"
				xmlns="http://www.w3.org/2000/svg"
				width="24"
		...
		<a
			title="linkedin"
			href="https://www.linkedin.com/in/rifkyabdulhanan/"
			target="_blank"
			rel="noopener"
		>
			<svg
		...
		<!-- <a title="youtube" href="https://www.youtube.com/user/lowkey/" target="_blank" rel="noopener">
